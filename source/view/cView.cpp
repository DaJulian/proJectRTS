...
bool cView::CleanUpInput()
{
    return 1;
}

bool cView::UseEvent(SDL_Event* Event)
{
    cEvent::UseEvent(Event);
	return 1;
}

void cView::InpKeyDown(SDLKey sym, SDLMod mod, Uint16 unicode)
{
	switch(sym)
	{
	    case SDLK_q:
...
void cView::InpKeyUp(SDLKey sym, SDLMod mod, Uint16 unicode)
{
	switch(sym)
	{
	    case SDLK_q:
...
void cView::InpMouseMove(int mX, int mY, int relX, int relY, bool LeftB, bool RightB, bool MiddleB)
{
    MouseX = mX;
    MouseY = mY;
    if(LMButton)
...
void cView::InpMouseButtonDown(Uint8 button,int mX, int mY)
{
    switch(button)
    {
...
void cView::InpMouseButtonUp(Uint8 button,int mX, int mY)
{
    switch(button)
    {
        case SDL_BUTTON_LEFT:
